...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      ...
      className={cn(
        "font-heading text-base font-semibold text-pretty [&:not(:has(~[data-slot=questionnaire-description]))]:mb-3",
        className
      )}
      {...props}
    />
...
function QuestionnaireDescription({
  ...
  return (
    <QuestionnairePrimitive.Description
      ...
      className={cn(
        "text-sm/relaxed text-pretty text-muted-foreground",
        className
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      <QuestionnairePrimitive.Input
        ...
        className={cn(
          "h-7 min-h-11 w-full min-w-0 rounded-md border border-input bg-input/20 px-2 py-0.5 text-base transition-[color,box-shadow,background-color] outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 sm:min-h-0 md:text-sm/relaxed dark:bg-input/30 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40",
...
function QuestionnaireError({
  ...
  return (
    <QuestionnairePrimitive.Error
      ...
      className={cn("mt-2 text-sm/relaxed text-destructive", className)}
      {...props}
    />
  )
}
